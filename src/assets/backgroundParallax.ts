{
  ...
  let currentBackgroundX: number = 0;
  let currentBackgroundY: number = 0;
   ...
   */
  const moveBackgroundTo = (xPosition: number, yPosition: number): void => {
   ...
   */
  const animateBackgroundMovement = (): void => {
